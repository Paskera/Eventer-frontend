...
function Ae() {
	...
	if (n.version = "3.3.0", n.removed = [], !t || !t.document || t.document.nodeType !== T.document || !t.Element) return n.isSupported = !1, n;
	...
	let { MUSTACHE_EXPR: Le, ERB_EXPR: Re, TMPLIT_EXPR: ze, DATA_ATTR: Be, ARIA_ATTR: Ve, IS_SCRIPT_OR_DATA: He, ATTR_WHITESPACE: Ue, CUSTOM_ELEMENT: We } = Ee, { IS_ALLOWED_URI: Ge } = Ee, A = null, Ke = y({}, [
		...
		"style",
		"xmlns"
	]), W = "http://www.w3.org/1998/Math/MathML", lt = "http://www.w3.org/2000/svg", G = "http://www.w3.org/1999/xhtml", K = G, ut = !1, dt = null, ft = y({}, [
		W,
		lt,
		G
	], ne), q = y({}, [
		...
		if (!t || !t.documentElement) {
			...
			try {
				t.documentElement.innerHTML = ut ? O : i;
			} catch {}
		}
		let a = t.body || t.documentElement;
		return e && n && a.insertBefore(r.createTextNode(n), a.childNodes[0] || null), K === G ? Fe.call(t, L ? "html" : "body")[0] : L ? t.documentElement : a;
	}, Ct = function(e) {
