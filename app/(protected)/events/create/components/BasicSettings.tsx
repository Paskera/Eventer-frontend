...
export function BasicSettings({ formData, onFormChange }: BasicSettingsProps) {
    const {
        eventName,
        description,
        venue,
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="space-y-3">
                ...
                <RadioGroup value={format} onValueChange={(value) => onFormChange('format', value as 'online' | 'offline' | 'hybrid')}>
            ...
            <div className="space-y-3">
                ...
                <RadioGroup value={participationType} onValueChange={(value) => onFormChange('participationType', value as 'solo' | 'team')} className="grid grid-cols-2 gap-3">
                    <Label
                        htmlFor="solo"
                        className={cn(
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                    ...
                    <Input
                        ...
                        placeholder="0"
                        value={usersCount || ''}
                        onChange={(e) => onFormChange('usersCount', parseInt(e.target.value) || 0)}
                        className="transition-all duration-200 focus:shadow-sm"
                    />
                </div>
